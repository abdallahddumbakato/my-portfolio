...
const Contact = () => {
	...
	const socialLinks = [
		...
		},
		{
			...
			label: 'LinkedIn',
			link: 'https://www.linkedin.com/in/ddumbaka/'
		},
		{
	...
	return (
		<>
			<SEO 
				title="Contact Ddumba Abdallah Kato - Platform & AI Systems Engineer"
				description="Get in touch with Ddumba Abdallah Kato for AI infrastructure, platform engineering, or DevOps collaboration opportunities. Contact via email, phone, or WhatsApp from Kampala, Uganda."
